package com.bidyut.common;


public interface CoreUrls {
	final static String PROTOCOL="https://";
	final static String HTTP_PORT="7070";
	final static String HOST="13.232.164.247";
	final static String PUBLIC_HOST="uat.mgurush.com";
	...
	final static String KCB_ACCOUNT_VALIDATION=PROTOCOL+PUBLIC_HOST+"/EOT-Banking-Core/rest/integtation/accountValidation";
	final static String KCB_ACCOUNT_LINKING=PROTOCOL+PUBLIC_HOST+"/EOT-Banking-Core/rest/integtation/linkKcbAccount";
	final static String KCB_ACCOUNT_DELINKING=PROTOCOL+PUBLIC_HOST+"/EOT-Banking-Core/rest/integtation/deLinkKcbAccount";
