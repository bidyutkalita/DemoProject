...
import com.eot.banking.common.Constants;
...
public class ExternalTransactionServiceImpl implements ExternalTransactionService {
	...
	@Override
	@Transactional
	public NileBatDepositeResponse processNileBatDeposit(NileBatDepositReqDTO reqDTO)
	{
		NileBatDepositeResponse batDepositeResponse = new NileBatDepositeResponse();
