...
public class KCBIntegration {
	...
	public static SOAPMessage createSoapRequet(KCBParameter requestParam) throws Exception {
		...
		envelope.addNamespaceDeclaration("api", "http://API.Interface.kcb/");
		...
		QName kcbInterfaceBody = new QName("KCBDarajaInterface");
		SOAPElement kcbInterfaceParam = message.getSOAPBody().addChildElement(kcbInterfaceBody);
		kcbInterfaceParam.setPrefix("api");
		...
		QName PayLoad = new QName("PayLoad");
		...
		kcbInterfaceParam.addTextNode(requestParam.getTransactionAmount().toString());
		...
		QName TransactionCurrency = new QName("TransactionCurrency");
		...
		QName CustomerMobileNo = new QName("CustomerMobileNo");
		kcbInterfaceParam = payLoad.addChildElement(CustomerMobileNo);
		kcbInterfaceParam.addTextNode(requestParam.getCustomerMobileNo());
	...
	private static KCBParameter createSoapResponse(SOAPMessage soapResponse) throws Exception {
		...
		//------------------------------------------------------------
		NodeList list = soapResponse.getSOAPBody().getElementsByTagName("ns3:DarajaResponse");
	...
	public SOAPMessage sendSoapMsg(SOAPMessage soapRequest, String url) {
